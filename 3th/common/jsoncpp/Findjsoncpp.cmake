...
# 设置目标名称
set(TS_PACKAGE_NAME jsoncpp)
set(TS_INCLUDE_FILES json/json.h)
set(TS_LIB_NAMES jsoncpp)
set(TS_DLL_NAMES jsoncpp.dll)
...
message(STATUS "TESTOUT: ${${TS_PACKAGE_NAME}_SHARED_LIBRARIES_RELEASE}")